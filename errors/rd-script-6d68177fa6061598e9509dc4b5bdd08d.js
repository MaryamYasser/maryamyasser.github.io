...
<center>
    <a href="https://www.amazon.eg/ref=cs_503_logo/">
        <img src="../images/G/01/x-locale/communities/people/logo.gif" width=153 height=37 alt="Amazon.eg" border=0></a>
    <p>
        ...
        <table cellpadding=3 width="90%" bgcolor=#ffffff border=0 cellspacing="2" align="center">
            <tr>
                <td>
                    ...
                    حدث خطأ عند محاولة معالجة طلبك. نحن نعمل على حل المشكلة ونتوقع حلها قريبًا. <p>

    يرجى ملاحظة أنه إذا كنت تحاول تقديم طلب، فلن تتم معالجته في هذا الوقت. يرجى المحاولة مرة أخرى في وقت لاحق.<p>

    نأسف للإزعاج!

    </td></tr>
    </table>
    <b><a href="https://www.amazon.eg/ref=cs_503_link/">اضغط هنا للعودة إلى أمازون الصفحة الرئيسية</a></b>
</center>
